...
public class QuartzJobController {
	...
	public QuartzJobController(Response response, QuartzJobService quartzJobService) {
	...
	public Response addJob(@Validated DetailJobDTO detailJobDTO) {
		final Boolean addJobResult = quartzJobService.addJob(detailJobDTO.getJobClassName(), detailJobDTO.getJobGroupName(),
	...
	public Response executeJob(@Validated SimpleJobDTO simpleJobDTO) {
		final Boolean executeJobResult = quartzJobService.executeJob(simpleJobDTO.getJobClassName(), simpleJobDTO.getJobGroupName());
	...
	public Response pauseJob(@Validated SimpleJobDTO simpleJobDTO) {
		final Boolean pauseJobResult = quartzJobService.pauseJob(simpleJobDTO.getJobClassName(), simpleJobDTO.getJobGroupName());
	...
	public Response resumeJob(@Validated SimpleJobDTO simpleJobDTO) {
		final Boolean resumeJobResult = quartzJobService.resumeJob(simpleJobDTO.getJobClassName(), simpleJobDTO.getJobGroupName());
	...
	public Response rescheduleJob(@Validated DetailJobDTO detailJobDTO) {
		final Boolean rescheduleJobResult = quartzJobService.rescheduleJob(detailJobDTO.getJobClassName(), detailJobDTO.getJobGroupName(),
	...
	public Response deleteJob(@PathVariable("job_class_name") String jobClassName, @PathVariable("job_group_Name") String jobGroupName) {
		final Boolean deleteJobResult = quartzJobService.deleteJob(jobClassName, jobGroupName);
	...
	public Response queryJob(@PathVariable("page_num") Integer pageNum, @PathVariable("page_size") Integer pageSize) {
		final IPage<JobAndTriggerVO> jobAndTriggerDetails = quartzJobService.getJobAndTriggerDetails(pageNum, pageSize);
